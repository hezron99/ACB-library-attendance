...
<nav class="navbar nav-main-dashboard navbar-bg-light" style="height:300px">  
    ...
    <figure class="text-center"style="position:relative;">
        <blockquote class="blockquote"></blockquote>
            <p class="text-light" style="font-size:30px">"Whoever pursues righteousness and love finds life, prosperity, and honor."</p>
        </blockquote>
                ...
                <!-- <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button> -->
                    ...
                    <div class="offcanvas-body">
                        ...
                        <div class="list-group">
                            <span style="font-size:large; font-weight:bold; margin-left:30px;position:relative; bottom:5px;">hi, Welcome Ms. Pria</span>
                            <br>
                            <br>
