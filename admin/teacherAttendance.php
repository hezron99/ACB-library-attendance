...
$result = $object->facultyLoginDetails();
?>
           ...
           <?php 
                    ...
                    foreach ($result as $data){?>
                        <tr>
                            ...
                            <td><?php echo $data['faculty_usn']?></td>
                            <td><?php echo $data['faculty_fullname']?><td>
                            <td><?php echo $data['department']?></td>
                            <td><?php echo $data['faculty_Purpose']?></td>
                            <td><?php echo $data['Others'] ?></td>
                            <td><?php echo $data['faculty_time_in']?></td>
