<?php
    ...
    <div class="container">
        <div class="container-grid mx-auto text-center"style="position:relative; bottom:50px;">
            <div class="row grid-row mx-auto">
                <div class="col column-grid mx-auto py-auto">
                    <div class="card shadow-lg bg-body rounded border border-0" style="width:80%;height:100%">
                        <div class="card-body">
                ...
                <div class="col column-grid mx-auto py-auto">
                    <div class="card shadow-lg  bg-body rounded border border-0" style="width:80%;height:100%">
                        <div class="card-body">
                            <h5 class="card-title display-6">Faculty</h5>
                            <?php
                                            // faculty attendance count
                                $facultylogs = $object->facultyLoginCount();
                                $counter = $facultylogs->rowCount();   
                            ?>
                            <p class="card-text display-6" style="font-size: 1.4"><?php echo strval($counter);?></p>
                ...
                <div class="col column-grid1 d-flex mx-auto">
                    <div class="card shadow-lg  bg-body rounded border border-0" style="width:80%;height:100%">
                        <div class="card-body">
            ...
            <div class="card text-center shadow rounded-5 border-0">
                <div class="card-body">
                    ...
                    <div class="row mx-auto mb-3" style="padding: 20px;">
                        <form  class = "w-25 d-flex" role = "search" method="POST" action="dashboard.php">
